...
import br.gov.mj.sislegis.parser.camara.PautaBean.ReuniaoBean;
...
public class ParserPautaCamara {
	...
	public List<Proposicao> getProposicoes(Integer idComissao, String datIni, String datFim) throws Exception {
		String wsURL = "http://www.camara.gov.br/SitCamaraWS/Orgaos.asmx/ObterPauta?IDOrgao="+idComissao+"&datIni="+datIni+"&datFim="+datFim;
	...
	private void config(XStream xstream) {
		...
		// Utilizamos o implicit quando os filhos já tem os dados que queremos buscar. Ou seja, não tem um pai e v�rios filhos do mesmo tipo.
